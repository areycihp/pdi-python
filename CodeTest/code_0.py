...
def algoritmo_region_bordes(imagen):    
   ...
   # Umbralización - Segmentación (7)
    ...
    tamanio_imagen('Imagen segmentada inundada')
    ...
    tamanio_imagen('Imagen segmentada invertida')
    ...
    # Marcadores de superficie a 8 bits - Técnicas y funciones de python (13.1)
    ...
    tamanio_imagen('Imagen etiquetada')
    cv.imshow('Imagen etiquetada', imagen)
    #Fin etiquetado

    #Proceso de realzado de contorno - Técnicas y funciones de python (14)
    ...
    tamanio_imagen('Imagen contorneada')
